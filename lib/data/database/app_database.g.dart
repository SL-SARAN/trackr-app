...
class $ExpensesTable extends Expenses with TableInfo<$ExpensesTable, Expense> {
  ...
  static const VerificationMeta _timeOfDayTagMeta = const VerificationMeta(
    'timeOfDayTag',
  );
  @override
  late final GeneratedColumn<String> timeOfDayTag = GeneratedColumn<String>(
    'time_of_day_tag',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('time_of_day_tag')) {
      context.handle(
        _timeOfDayTagMeta,
        timeOfDayTag.isAcceptableOrUnknown(
          data['time_of_day_tag']!,
          _timeOfDayTagMeta,
        ),
      );
    } else if (isInserting) {
      context.missing(_timeOfDayTagMeta);
    }
    if (data.containsKey('created_at')) {
      context.handle(
        _createdAtMeta,
  ...
  Expense map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Expense(
      ...
      timeOfDayTag: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}time_of_day_tag'],
      )!,
      createdAt: attachedDatabase.typeMapping.read(
        DriftSqlType.dateTime,
        data['${effectivePrefix}created_at'],
...
class Expense extends DataClass implements Insertable<Expense> {
  ...
  Expense copyWithCompanion(ExpensesCompanion data) {
    return Expense(
      ...
      timeOfDayTag: data.timeOfDayTag.present
...
class ExpensesCompanion extends UpdateCompanion<Expense> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (timeOfDayTag.present) {
      map['time_of_day_tag'] = Variable<String>(timeOfDayTag.value);
    }
    if (createdAt.present) {
      map['created_at'] = Variable<DateTime>(createdAt.value);
    }
...
class $TasksTable extends Tasks with TableInfo<$TasksTable, Task> {
  ...
  static const VerificationMeta _isPlannedExpenseMeta = const VerificationMeta(
    'isPlannedExpense',
  );
  @override
  late final GeneratedColumn<bool> isPlannedExpense = GeneratedColumn<bool>(
    'is_planned_expense',
    aliasedName,
    false,
    type: DriftSqlType.bool,
    requiredDuringInsert: false,
    defaultConstraints: GeneratedColumn.constraintIsAlways(
      'CHECK ("is_planned_expense" IN (0, 1))',
    ),
    defaultValue: const Constant(false),
  );
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('is_planned_expense')) {
      context.handle(
        _isPlannedExpenseMeta,
        isPlannedExpense.isAcceptableOrUnknown(
          data['is_planned_expense']!,
          _isPlannedExpenseMeta,
        ),
      );
    }
  ...
  Task map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Task(
      ...
      isPlannedExpense: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}is_planned_expense'],
      )!,
...
class Task extends DataClass implements Insertable<Task> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['is_planned_expense'] = Variable<bool>(isPlannedExpense);
  ...
  factory Task.fromJson(
    ...
    return Task(
      ...
      isPlannedExpense: serializer.fromJson<bool>(json['isPlannedExpense']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'isPlannedExpense': serializer.toJson<bool>(isPlannedExpense),
  ...
  Task copyWith({
    ...
    isPlannedExpense: isPlannedExpense ?? this.isPlannedExpense,
  ...
  Task copyWithCompanion(TasksCompanion data) {
    return Task(
      ...
      isCompleted: data.isCompleted.present
          ...
          : this.isCompleted,
      isPlannedExpense: data.isPlannedExpense.present
          ? data.isPlannedExpense.value
          : this.isPlannedExpense,
  ...
  String toString() {
    return (StringBuffer('Task(')
          ...
          ..write('isPlannedExpense: $isPlannedExpense, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is Task &&
          ...
          other.isPlannedExpense == this.isPlannedExpense &&
...
class TasksCompanion extends UpdateCompanion<Task> {
  ...
  final Value<bool> isPlannedExpense;
  ...
  const TasksCompanion({
    ...
    this.isPlannedExpense = const Value.absent(),
  ...
  static Insertable<Task> custom({
    ...
    Expression<bool>? isPlannedExpense,
    ...
    return RawValuesInsertable({
      ...
      if (isPlannedExpense != null) 'is_planned_expense': isPlannedExpense,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (isPlannedExpense.present) {
      map['is_planned_expense'] = Variable<bool>(isPlannedExpense.value);
    }
...
class $BudgetsTable extends Budgets with TableInfo<$BudgetsTable, Budget> {
  ...
  @override
  List<GeneratedColumn> get $columns => [id, amount, periodStart, isActive];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class Budget extends DataClass implements Insertable<Budget> {
  ...
  @override
  int get hashCode => Object.hash(id, amount, periodStart, isActive);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Budget &&
...
final class $$ExpensesTableReferences
  ...
  static MultiTypedResultKey<$TasksTable, List<Task>> _tasksRefsTable(
    ...
    db.tasks,
    aliasName: $_aliasNameGenerator(db.expenses.id, db.tasks.linkedExpenseId),
  );
  ...
  $$TasksTableProcessedTableManager get tasksRefs {
    final manager = $$TasksTableTableManager(
      $_db,
      $_db.tasks,
    ).filter((f) => f.linkedExpenseId.id.sqlEquals($_itemColumn<int>('id')!));
...
class $$ExpensesTableFilterComposer
  ...
  ColumnFilters<String> get timeOfDayTag => $composableBuilder(
    column: $table.timeOfDayTag,
    builder: (column) => ColumnFilters(column),
  );
  ...
  Expression<bool> tasksRefs(
    ...
    final $$TasksTableFilterComposer composer = $composerBuilder(
      ...
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.tasks,
      getReferencedColumn: (t) => t.linkedExpenseId,
      builder:
          (
            joinBuilder, {
            $addJoinBuilderToRootComposer,
...
class $$ExpensesTableOrderingComposer
  ...
  ColumnOrderings<String> get timeOfDayTag => $composableBuilder(
    column: $table.timeOfDayTag,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$ExpensesTableAnnotationComposer
  ...
  GeneratedColumn<String> get timeOfDayTag => $composableBuilder(
    column: $table.timeOfDayTag,
    builder: (column) => column,
  );
          ...
          prefetchHooksCallback: ({categoryId = false, tasksRefs = false}) {
            return PrefetchHooks(
              ...
              getPrefetchedDataCallback: (items) async {
                return [
                  if (tasksRefs)
                    await $_getPrefetchedData<Expense, $ExpensesTable, Task>(
                      currentTable: table,
                      referencedTable: $$ExpensesTableReferences
                          ._tasksRefsTable(db),
                      managerFromTypedResult: (p0) =>
                          $$ExpensesTableReferences(db, table, p0).tasksRefs,
                      referencedItemsForCurrentItem: (item, referencedItems) =>
                          referencedItems.where(
                            (e) => e.linkedExpenseId == item.id,
                          ),
                      typedResults: items,
                    ),
                ];
...
final class $$TasksTableReferences
  ...
  static $ExpensesTable _linkedExpenseIdTable(_$AppDatabase db) =>
      db.expenses.createAlias(
        $_aliasNameGenerator(db.tasks.linkedExpenseId, db.expenses.id),
      );

  $$ExpensesTableProcessedTableManager? get linkedExpenseId {
    final $_column = $_itemColumn<int>('linked_expense_id');
    if ($_column == null) return null;
    final manager = $$ExpensesTableTableManager(
      $_db,
      $_db.expenses,
    ).filter((f) => f.id.sqlEquals($_column));
    final item = $_typedResult.readTableOrNull(_linkedExpenseIdTable($_db));
    if (item == null) return manager;
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: [item]),
    );
...
class $$TasksTableFilterComposer extends Composer<_$AppDatabase, $TasksTable> {
  ...
  ColumnFilters<bool> get isPlannedExpense => $composableBuilder(
    column: $table.isPlannedExpense,
    builder: (column) => ColumnFilters(column),
  );
  ...
  $$ExpensesTableFilterComposer get linkedExpenseId {
    final $$ExpensesTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.linkedExpenseId,
      referencedTable: $db.expenses,
      getReferencedColumn: (t) => t.id,
      builder:
          (
...
class $$TasksTableOrderingComposer
  ...
  ColumnOrderings<bool> get isPlannedExpense => $composableBuilder(
    column: $table.isPlannedExpense,
    builder: (column) => ColumnOrderings(column),
  );
  ...
  $$ExpensesTableOrderingComposer get linkedExpenseId {
...
class $$TasksTableAnnotationComposer
  ...
  GeneratedColumn<bool> get isPlannedExpense => $composableBuilder(
    column: $table.isPlannedExpense,
    builder: (column) => column,
  );
  ...
  $$ExpensesTableAnnotationComposer get linkedExpenseId {
    final $$ExpensesTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.linkedExpenseId,
      referencedTable: $db.expenses,
...
class $$TasksTableTableManager
    extends
        RootTableManager<
          ...
          Task,
          PrefetchHooks Function({bool linkedExpenseId, bool categoryId})
        > {
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<bool> isPlannedExpense = const Value.absent(),
                Value<int?> linkedExpenseId = const Value.absent(),
                Value<double?> estimatedAmount = const Value.absent(),
                Value<int?> categoryId = const Value.absent(),
                Value<int?> notificationId = const Value.absent(),
          ...
          prefetchHooksCallback:
              ({linkedExpenseId = false, categoryId = false}) {
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [],
                  addJoins:
                      ...
                      >(state) {
                        if (linkedExpenseId) {
                          state =
                              state.withJoin(
                                    currentTable: table,
                                    currentColumn: table.linkedExpenseId,
                                    referencedTable: $$TasksTableReferences
                                        ._linkedExpenseIdTable(db),
